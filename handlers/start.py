...
async def handle_start(message: Message, state: FSMContext):
    ...
    await message.answer(
        ...
        "а также соглашаетесь на получение информационных сообщений.\n\n"
        "Все мои консультации носят информационный характер. Финальное решение подтверждает эксперт команды Терион.",
