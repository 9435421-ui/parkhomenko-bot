...
class VKBot:
    ...
    def handle_message(self, event):
        ...
        if text in ["начать", "start", "привет"]:
            ...
            response = call_llm("Ты - Антон, ИИ-консультант ТЕРИОН: Согласование и Проектирование. Отвечай кратко.", text)
            self.send_message(user_id, response)

    def send_welcome(self, user_id):
        welcome_text = (
            "Привет! Я Антон, ИИ-консультант сервиса «ТЕРИОН: Согласование и Проектирование». 🏠\n\n"
