# Карта агентов проекта «ТОРИОН» — перепланировки
...
- не принимает финальных бизнес-решений (это делает наш эксперт), но предлагает варианты решений.
...
## Текущий Bot Agent: ИИ-консультант (перепланировки)
...
- Подготавливать ответы на комментарии/вопросы под постами:
  - в стиле ИИ-консультанта и компании;
