...
- Обязательный CTA к боту @torion_bot
...
- CTA к боту @torion_bot для разбора конкретной ситуации{theme_note}
...
Задача: генерировать посты, которые прогревают к заявке в бота @torion_bot.
...
- Один аккуратный CTA к боту @torion_bot
