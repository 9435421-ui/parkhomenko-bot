...
class ContentAgent:
    ...
    def _build_prompt(self, post_type, theme=None):
        ...
        prompts = {
            "news": f"""
Создай пост о правовых изменениях или рыночных трендах в недвижимости Москвы.
{theme_note}
Требования:
- Стиль: дорогой консалтинг.
- Суть: как новое постановление или разъяснение Мосжилинспекции влияет на СТОИМОСТЬ и ЛИКВИДНОСТЬ объекта.
