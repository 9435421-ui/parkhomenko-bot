...
""",
            'поздравление': f"""
Создай персональное поздравление с днем рождения для клиента.

Тема: {theme_note or 'Поздравление с днем рождения'}

Требования:
- Теплое, персональное поздравление
- Связка с темой перепланировок (пожелать успехов в будущих проектах)
- 80–150 слов, искренне и по-человечески
- Легкий CTA к боту @Parkhovenko_i_kompaniya_bot для новых проектов
