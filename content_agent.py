...
""",
            'поздравление': f"""
Создай искреннее поздравление с днём рождения для подписчика канала от имени команды «Пархоменко и компания».

Имя: {theme_note or 'наш подписчик'}

Требования:
- Тёплое, искреннее поздравление (80-120 слов)
- Пожелания счастья, здоровья, уюта в доме и исполнения желаний
- Дружелюбный, человечный tone of voice
- БЕЗ упоминания услуг, перепланировок или CTA
- От имени всей команды компании

Формат ответа:
🎂 [Имя или "Дорогой подписчик"]

[Искреннее поздравление с пожеланиями]
