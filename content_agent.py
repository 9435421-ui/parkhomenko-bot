...
class ContentAgent:
    ...
    def _build_prompt(self, post_type, theme=None):
        ...
        prompts = {
            'экспертиза': f"""
Создай экспертный пост для Telegram-канала «ЛАД В КВАРТИРЕ».
...
- Обязательный CTA к боту наш бот-ассистент
...
""",
            'живой': f"""
 Создай «живой» пост для Telegram-канала «ЛАД В КВАРТИРЕ».
...
""",
            'новость': f"""
 Создай новостной пост для Telegram-канала «ЛАД В КВАРТИРЕ».
...
- CTA к боту наш бот-ассистент для разбора конкретной ситуации{theme_note}
...
"""
            ...
            system_prompt = f"""
Ты — контент-менеджер Telegram-канала «ЛАД В КВАРТИРЕ».

Задача: генерировать посты, которые прогревают к заявке в бота наш бот-ассистент.
...
- Один аккуратный CTA к боту наш бот-ассистент
