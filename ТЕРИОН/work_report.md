...
Работа по настройке проекта выполнена частично. Основные компоненты установлены, но есть проблемы с зависимостями, требующие дополнительной настройки. Проект готов к дальнейшей разработке и тестированию после решения проблем с установкой пакетов.