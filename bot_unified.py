...
🕐 Запрос клиента: {preferred_time}
    ...
    bot.send_message(
        ...
        f"👨‍💼 Наш специалист из команды «Пархоменко и компания» постарается позвонить в это время.\n\n"
        f"📅 Рабочее время: пн-пт 9:00-18:00, сб 10:00-16:00.",
    )
...
5. УПОМИНАЙ КОМПАНИЮ: минимум в каждом 2-м ответе (говори 'наша команда', 'Пархоменко и компания', 'мы делали...')
...
8. УЧИТЫВАЙ ВРЕМЯ (Смотри 'ТЕКУЩЕЕ ВРЕМЯ' в конце промпта):
   - Если сейчас ночь или выходные → говори, что специалист свяжется 'в понедельник утром' или 'в ближайший рабочий день'.
   - Если сейчас рабочее время (пн-пт 9-18, сб 10-16) → говори, что свяжемся 'в течение часа'.
9. СТОИМОСТЬ:
...
10. ВОПРОСЫ НА ЧЕЛОВЕЧЕСКОМ ЯЗЫКЕ:
...
""".strip()
    ...
    current_time_str = f"{now.strftime('%H:%M')}, {days[now.weekday()]}"
