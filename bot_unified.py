...
def show_privacy_consent(chat_id: int):
    ...
    text = (
        "Прежде чем мы начнем, я должен сообщить: я, Антон — ИИ-ассистент компании Терион. "
        "Нажимая кнопку \"Начать\", вы даете согласие на обработку персональных данных, "
        "принимаете условия политики конфиденциальности и соглашаетесь на получение информационных сообщений.\n\n"
        "Все мои ответы носят информационный характер. Финальное решение по вашему случаю подтверждает эксперт команды Терион.\n\n"
