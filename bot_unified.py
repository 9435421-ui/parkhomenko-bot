...
PRIVACY_POLICY_TEXT = (
    "📋 Добро пожаловать в бот Юлии Пархоменко о перепланировках и согласовании квартир!\n\n"
    "Перед началом работы необходимо:\n"
    "✅ Согласие на обработку персональных данных\n"
    "✅ Согласие на получение уведомлений\n\n"
    "Бот поможет оценить риски отказа, понять, что узаконить, и собрать данные для консультации со специалистом.\n"
    "• Информация носит ознакомительный характер\n"
    "• Мы соблюдаем законодательство РФ"
)

AI_INTRO_TEXT = (
    "🤖 Бот Юлии Пархоменко о перепланировках и согласовании квартир.\n\n"
    "Помогает оценить риски отказа, понять, что узаконить, и собрать данные для консультации со специалистом."
)
