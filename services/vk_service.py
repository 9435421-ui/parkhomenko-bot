...
РџСѓР±Р»РёРєР°С†РёСЏ РїРѕСЃС‚РѕРІ РІ СЃРѕРѕР±С‰РµСЃС‚РІРѕ + РєРІРёР· GEORIS.
"""
import os
import logging
...
# РЎСЃС‹Р»РєР° РЅР° РєРІРёР· GEORIS - РЅР°СЃС‚СЂРѕР№С‚Рµ РІ .env РёР»Рё РёСЃРїРѕР»СЊР·СѓР№С‚Рµ Р·РЅР°С‡РµРЅРёРµ РїРѕ СѓРјРѕР»С‡Р°РЅРёСЋ
...
class VKService:
    ...
    async def post_with_quiz_cta(
        ...
        """
        РџСѓР±Р»РёРєСѓРµС‚ РїРѕСЃС‚ СЃ РїСЂРёР·С‹РІРѕРј РїСЂРѕР№С‚Рё РєРІРёР· GEORIS.
