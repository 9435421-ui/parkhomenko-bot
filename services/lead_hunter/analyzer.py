...
class LeadAnalyzer:
    ...
    async def analyze_post(self, text: str) -> float:
        ...
        Твоя задача:
        1. Оцени по шкале от 0.0 до 1.0, насколько это сообщение является целевым запросом (лидом).
        2. Целевой запрос — это вопросы про ремонт, перепланировку, документы, ипотеку в указанных городах.
        3. Ответ дай ОДНИМ ЧИСЛОМ.
        """
